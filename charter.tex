...
\begin{figure}[h!]
	\centering 
	\includegraphics[width=1.1\textwidth]{./Figuras/gantt-01.png}
...
\begin{figure}[h!]
	\centering 
	\includegraphics[width=1.1\textwidth]{./Figuras/gantt-02.png}
	\caption{Ejemplo de diagrama de Gantt rotado}
	\label{fig:diagGantt}
\end{figure}
...
\begin{figure}[h!]
\centering 
\includegraphics[height=0.68\textheight]{./Figuras/gantt.png}
\caption{Ejemplo de diagrama de Gantt rotado}
\label{fig:diagGantt}
\end{figure}
