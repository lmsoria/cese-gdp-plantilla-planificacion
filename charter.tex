...
4      & Se completa hasta el punto 15 inclusive                 & 27 de septiembre de 2023 \\ \hline
5      & Aplicadas correcciones finales                         & 28 de septiembre de 2023 \\ \hline
\end{tabularx}
\end{table}
...
Tal como se mencionó anteriormente, algunos equipos poseen un conector adicional denominado \textbf{MIDI THRU}, que retransmite los mensajes recibidos. Esto permite crear topologías denominadas \emph{Daisy Chain}, en las que la salida de un equipo A se conecta a la entrada de un equipo B, y así sucesivamente. Sin embargo, no todos los instrumentos poseen esta característica.
...
\begin{itemize}
	...
	\item Ocurrencia (O): 8, al tratarse un equipo que podría usarse en situaciones de música en vivo y ser manipulado por personal no técnico, el riesgo de daños es considerable. 
\end{itemize}
...
\begin{table}[htpb]
	...
	\begin{tabularx}{\linewidth}{@{}|X|c|c|c|c|c|c|@{}}
		...
		Dificultad/demoras en la importación de componentes & 8 & 7 & \cellcolor[HTML]{FFCCC9}{\color[HTML]{FE0000} \textbf{56}} & 5 & 6 & \cellcolor[HTML]{C1E0C9}{\color[HTML]{3F7E31} \textbf{30}} \\ \hline
		...
		Rotura del prototipo durante la etapa de tests de usabilidad & 9 & 8 & \cellcolor[HTML]{FFCCC9}{\color[HTML]{FE0000} \textbf{72}} & 3 & 8 & \cellcolor[HTML]{C1E0C9}{\color[HTML]{3F7E31} \textbf{24}} \\ \hline
	\end{tabularx}
\end{table}

Junto al director del proyecto se acordó que se tomarán medidas de mitigación en aquellos riesgos cuyo número de RPN sea mayor o igual a 31.
...
\begin{itemize}
	...
	\item Ocurrencia (O*): 6, en Uruguay las probabilidades de restricciones aduaneras son menores.
\end{itemize}
...
\begin{itemize} 	
	\item \textbf{Requerimiento 1.2:} el equipo deberá tener por lo menos 4 (cuatro) conectores de entrada.
	\begin{itemize}
	...
	\item \textbf{Requerimiento 1.3:} el equipo deberá tener por lo menos 8 (ocho) conectores de salida.
	\begin{itemize}
	...
	\item \textbf{Requerimiento 3.2:} el equipo deberá ser \emph{class-compliant} (es decir, no requerir de drivers adicionales para
	...
	\item \textbf{Requerimiento 3.4:} los puertos MIDI de entrada y salida deberán ser accesibles desde la computadora.
	\begin{itemize}
	...
	\item \textbf{Requerimiento 4.1:} la comunicación Humano-Máquina más elemental se realizará mediante un display
	...
	\item \textbf{Requerimiento 4.3:} la configuración de \emph{routeo} y filtrado de mensajes se realizará a través de una aplicación gráfica.
	\begin{itemize}
		\item Verificación: se desarrollará una aplicación con la funcionalidad requerida.
		\item Validación: se mostrará el funcionamiento del equipo con esta característica.  
	\end{itemize}
	
	\item \textbf{Requerimiento 5.2:} el equipo deberá ser capaz de almacenar al menos 16 (dieciseis) presets configurables por el usuario.
	\begin{itemize}
		\item Verificación: se desarrollará esta característica durante la fase de diseño del firmware, y será probada durante la etapa de testing.
		\item Validación: se mostrará el funcionamiento del equipo con esta característica.
	\end{itemize}

	\item \textbf{Requerimiento 5.4:} la pantalla LCD deberá mostrar el preset activo.
	\begin{itemize}
		\item Verificación: se desarrollará esta característica durante la fase de diseño del firmware.
		\item Validación: se mostrará el funcionamiento del equipo con esta característica.
	\end{itemize}

	\item \textbf{ Requerimiento 7.2:} se deberá confeccionar un manual de uso orientado a potenciales usuarios que podrían no contar con conocimiento técnico.
	\begin{itemize}
	...
	\item \textbf{Requerimiento 8.1:} todo el equipamiento deberá caber en un gabinete tipo \emph{rack} de 1RU (\emph{Rack Unit}, 44,5 mm) de dimensiones 44,5 x 483 x 120 mm.
	\begin{itemize}
