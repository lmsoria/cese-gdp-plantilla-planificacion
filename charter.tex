...
Cabe destacar que la comunicación MIDI no es solo entre instrumentos, si no que también puede ser entre instrumentos y una computadora personal. Cada uno de los equipos puede ser tanto transmisor como receptor de mensajes. Sin embargo, debe existir un conector para cada dirección, tal como se muestra en la Figura \ref{fig:01-midi-connector}. El tipo más utilizado es el DIN-5 para entornos donde no hay una PC interviniendo, aunque hoy en día también hay instrumentos capaces de transferir mensajes MIDI vía USB.
...
\begin{itemize}
	...
	\item Orientador: \supname tiene experiencia en RTOS y gestión de proyectos. Aprovechar estas cualidades.
\end{itemize}
...
El propósito de este proyecto es desarrollar un equipo con las características mencionadas en la sección \ref{sec:descripcion}. Se pretende que el mismo sea funcional. Por otro lado, el responsable se propone realizar una prueba piloto para evaluar la viabilidad de venta del desarrollo, de modo de introducirse en la comunidad de fabricante de equipos electrónicos relacionados con la producción musical.
